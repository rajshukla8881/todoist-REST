...
public class TaskController {
    ...
    @GetMapping("/tasks")
    @ResponseBody
    public ResponseEntity<List<ActiveTaskResponse>> getActiveTaskList(@RequestHeader(value="Authorization") String userAuthorization) {
        return new ResponseEntity<>(taskService.getActiveTasks(userAuthorization), HttpStatus.OK);
    }

    @PostMapping("/tasks")
    @ResponseBody
    public ResponseEntity<CreateTaskResponse> taskCreation(@RequestHeader(value="Authorization") String userAuthorization,@RequestBody TaskRequest taskRequest) {
        CreateTaskResponse createTaskResponse = taskService.createTask(taskRequest,userAuthorization);
